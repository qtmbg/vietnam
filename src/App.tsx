...
const TRIP_DATA: TripData = {
  ...
  // =========================
  {
    ...
    city: "Hanoi",
    window: "25–28 juil",
    name: "Marionnettes sur l’eau (Thang Long) — sièges Standard",
    category: "spectacle",
    provider: "Traveloka",
    payMode: "Billets",
    duration: "50 min",
    kidsRule: "Enfants acceptés (arriver 20–30 min avant)",
    notes: "Budget calculé pour 5 personnes (3 adultes + 2 enfants).",
    impact: false,
    pricing: {
      currency: "USD",
      estimatedUSD_total: 29, // $28.88 arrondi
      quantity: 5,
      basis: "150k VND/pers",
    },
    sourceUrl:
      "https://www.traveloka.com/en-vn/activities/vietnam/product/thang-long-water-puppet-show-tickets-skip-the-line-2001486919941",
  },
  {
    id: "PA-HN-002",
    city: "Hanoi",
    window: "25–28 juil",
    name: "Musée Hoa Lo — entrée",
    category: "musée",
    provider: "Vietnam Airlines",
    payMode: "Sur place",
    duration: "1–2 h",
    kidsRule: "Enfant <6 ans gratuit (hypothèse: 6 ans payant / 12 ans payant)",
    notes: "Budget calculé pour 4 billets payants.",
    impact: false,
    pricing: {
      currency: "USD",
      estimatedUSD_total: 8, // $7.70 arrondi
      quantity: 4,
      basis: "50k VND/pers (payant)",
    },
    sourceUrl:
      "https://www.vietnamairlines.com/us/en/plan-book/travel/travel-guide/hoa-lo-prison",
  },
  ...
  // =========================
  {
    ...
    city: "Ninh Binh",
    window: "28–30 juil",
    name: "Trang An (UNESCO) — barque (règles par taille)",
    category: "nature",
    provider: "VinWonders",
    payMode: "Sur place",
    duration: "2–3 h",
    kidsRule: "Prudent: enfant 12 ans compté adulte; enfant 6 ans tarif enfant",
    notes: "4 adultes x 250k + 1 enfant x 120k.",
    impact: false,
    pricing: {
      currency: "USD",
      estimatedUSD_total: 43, // $43.12 arrondi
      quantity: 5,
      basis: "Tarifs officiels VND",
    },
    sourceUrl: "https://vinwonders.com/en/wonderpedia/news/trang-an-boat-tour/",
  },
  {
    id: "PA-NB-004",
    city: "Ninh Binh",
    window: "28–30 juil",
    name: "Hang Mua (Mua Caves) — entrée",
    category: "vue / randonnée",
    provider: "Vinpearl",
    payMode: "Sur place",
    duration: "1–2 h",
    kidsRule: "OK enfants (prévoir eau + chaussures)",
    notes: "Budget calculé pour 5 billets.",
    impact: false,
    pricing: {
      currency: "USD",
      estimatedUSD_total: 19, // $19.26 arrondi
      quantity: 5,
      basis: "100k VND/pers",
    },
    sourceUrl: "https://vinpearl.com/en/mua-caves-ninh-binh",
  },
  ...
  // =========================
  {
    ...
    city: "Hoi An",
    window: "1–6 août",
    name: "Hoi An Ancient Town — ticket UNESCO",
    category: "culture",
    provider: "HoiAn Day Trip",
    payMode: "Sur place",
    duration: "2–4 h",
    kidsRule: "Ticket surtout pour adultes / règles variables selon âge",
    notes: "Budget calculé pour 3 adultes.",
    impact: false,
    pricing: {
      currency: "USD",
      estimatedUSD_total: 14, // $13.86 arrondi
      quantity: 3,
      basis: "120k VND/adulte",
    },
    sourceUrl:
      "https://hoiandaytrip.com/hoi-an-old-town-ticket-attractions/",
  },
  {
    id: "PA-HA-006",
    city: "Hoi An",
    window: "1–6 août",
    name: "My Son Sanctuary — tickets (tarifs 2026)",
    category: "culture / UNESCO",
    provider: "FVG Travel",
    payMode: "Sur place",
    duration: "2–3 h",
    kidsRule: "Enfants 5–15: tarif enfant",
    notes: "3 adultes + 2 enfants (5–15).",
    impact: false,
    pricing: {
      currency: "USD",
      estimatedUSD_total: 21, // $21.18 arrondi
      quantity: 5,
      basis: "150k adulte / 50k enfant",
    },
    sourceUrl:
      "https://fvgtravel.com.vn/en/news/gia-ve-thanh-dia-my-son-new-n343",
  },
  {
    id: "PA-HA-007",
    city: "Hoi An",
    window: "1–6 août",
    name: "Coconut Basket Boat (Cam Thanh / Bay Mau)",
    category: "expérience",
    provider: "La Siesta",
    payMode: "Sur place",
    duration: "45–60 min",
    kidsRule: "OK enfants",
    notes: "Budget prudent: 200k VND/pers (haut de fourchette).",
    impact: false,
    pricing: {
      currency: "USD",
      estimatedUSD_total: 39, // $38.51 arrondi
      quantity: 5,
      basis: "200k VND/pers",
    },
  ...
  },
  {
    ...
    city: "Hoi An",
    window: "1–6 août",
    name: "Hoi An Memories Show — billets ECO",
    category: "spectacle",
    provider: "Hoi An Memories Show (officiel)",
    payMode: "En ligne",
    duration: "1–1h30",
    kidsRule: "OK enfants",
    notes: "Budget calculé pour 5 billets.",
    ...
    pricing: {
      currency: "USD",
      estimatedUSD_total: 104, // $103.97 arrondi
      quantity: 5,
      basis: "540k VND/pers",
    },
  ...
  // =========================
  {
    ...
    city: "Da Nang",
    window: "6–8 août",
    name: "Marble Mountains — entrée + ascenseur (1 trajet)",
    category: "nature / pagodes",
    provider: "Ahoy Vietnam",
    payMode: "Sur place",
    duration: "2–3 h",
    kidsRule: "OK enfants",
    notes: "Entrée 40k + ascenseur 15k par personne.",
    impact: false,
    pricing: {
      currency: "USD",
      estimatedUSD_total: 11, // $10.59 arrondi
      quantity: 5,
      basis: "55k VND/pers",
    },
    sourceUrl:
      "https://ahoyvietnam.com/am-phu-cave-and-the-marble-mountains/",
  },
  {
    id: "PA-DN-010",
    city: "Da Nang",
    window: "6–8 août",
    name: "Ba Na Hills (Golden Bridge) — ticket 2026",
    category: "parc",
    provider: "Sun Paradise Land",
    payMode: "En ligne",
    duration: "Journée",
    kidsRule: "Prudent: enfant 12 ans compté adulte si >1.4m",
    notes: "4 billets adulte + 1 billet enfant (prudent).",
    impact: false,
    pricing: {
      currency: "USD",
      estimatedUSD_total: 185, // $184.83 arrondi
      quantity: 5,
      basis: "1,000,000 VND adulte / 800,000 VND enfant",
    },
    sourceUrl:
  ...
  // =========================
  {
    ...
    city: "Ho Chi Minh City",
    window: "12–15 août",
    name: "Mekong Delta — tour groupe (GetYourGuide)",
    category: "excursion",
    provider: "GetYourGuide",
    payMode: "En ligne",
    duration: "8–9 h",
    kidsRule: "OK enfants (vérifier conditions exactes au booking)",
    notes: "Budget calculé pour 5 personnes.",
    impact: false,
    pricing: {
      currency: "USD",
      estimatedUSD_total: 85,
      quantity: 5,
      basis: "$17/pers",
    },
    sourceUrl:
      "https://www.getyourguide.com/ho-chi-minh-city-l272/from-ho-chi-minh-city-mekong-delta-small-group-tour-t60784/",
  },
  {
    id: "PA-HCM-012",
    city: "Ho Chi Minh City",
    window: "12–15 août",
    name: "Cu Chi Tunnels — tour bus/minivan (GetYourGuide)",
    category: "histoire",
    provider: "GetYourGuide",
    payMode: "En ligne",
    duration: "5–6 h",
    kidsRule: "OK enfants (prévoir chaleur)",
    notes: "Budget calculé pour 5 personnes.",
    impact: false,
    pricing: {
      currency: "USD",
      estimatedUSD_total: 75,
      quantity: 5,
      basis: "$15/pers",
    },
    sourceUrl: "https://www.getyourguide.com/cu-chi-tunnels-l3671/",
  },
],
